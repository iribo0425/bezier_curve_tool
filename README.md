...
| 4 | Tan Hadle Angle | 接線ハンドルの角度を設定します。 <br><img src="image/gui001.jpg" width="200">|
| 5 | Tan Handle Length | 接線ハンドルの長さを設定します。1で編集ポイント間の距離と同じ長さになるように、正規化されています。 |
| 6 | Tan Handle Height | 接線ハンドルの高さを設定します。<br>ZX (Top)の例:<br><img src="image/gui002.jpg" width="200"> |
